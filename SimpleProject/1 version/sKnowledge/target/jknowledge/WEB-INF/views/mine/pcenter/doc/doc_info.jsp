...
<body class="page-header-fixed">
	...
	<div class="page-container row-fluid">
		<div class="page-sidebar nav-collapse collapse">
			<ul class="page-sidebar-menu">
				...
				<li class="start active">
					...
					<ul class="sub-menu">
					<input id="checkDoc" name="checkDoc" type="hidden" value="${currentUser.username}" /> 
		...
		<div class="page-content">
			...
			<iframe src="${pageContext.request.contextPath}/mine/doc_search" style="width:75%;height:600px;margin-left: 50px"></iframe>
				 <%-- <%@ include file="/WEB-INF/views/mine/pcenter/doc/doc_search.jsp" %> --%>
					<%-- <a href="#">
...
function checkInfo(op){
	var username=document.getElementById("checkDoc").value;
	if(username==""){
		alert("请先登录");
		return;
	}
